...
type ClusterNodeSecurityGroup struct {
	VbcIsolMaster   *string `json:"vbc_isol_master" name:"vbc_isol_master"`
	Description     *string `json:"description" name:"description"`
	TrustedSgMaster *string `json:"trusted_sg_master" name:"trusted_sg_master"`
	Controller      *string `json:"controller" name:"controller"`
	ConsoleId       *string `json:"console_id" name:"console_id"`
	RootUserId      *string `json:"root_user_id" name:"root_user_id"`
	Owner           *string `json:"owner" name:"owner"`
	GroupName       *string `json:"group_name" name:"group_name"`
	GroupId         *string `json:"group_id" name:"group_id"`
	GroupType       *string `json:"group_type" name:"group_type"`
	CreateTime      *string `json:"create_time" name:"create_time"`
	IsApplied       *int    `json:"is_applied" name:"is_applied"`
	IsTrusted       *int    `json:"is_trusted" name:"is_trusted"`
	IsDefault       *int    `json:"is_default" name:"is_default"`
	IsGlobal        *int    `json:"is_global" name:"is_global"`
	VbcIsolEnable   *int    `json:"vbc_isol_enable" name:"vbc_isol_enable"`
}
